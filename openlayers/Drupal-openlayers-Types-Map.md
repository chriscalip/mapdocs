...
* This class implements: [Drupal\openlayers\Types\MapInterface](Drupal-openlayers-Types-MapInterface.md)
...
### getId
    ...
    string Drupal\openlayers\Types\MapInterface::getId()
...
* Visibility: **public**
* This method is defined by [Drupal\openlayers\Types\MapInterface](Drupal-openlayers-Types-MapInterface.md)
...
### build
    ...
    array Drupal\openlayers\Types\MapInterface::build(array $build)
...
#### Arguments
* $build **array** - &lt;p&gt;The build array before being completed.&lt;/p&gt;
